...
#include <d3d11_2.h>
#endif
#elif defined(XR_DIRECTXTEX_DXVK_NATIVE)
// Reuse dxvk-native's own Windows/COM/D3D headers instead of DirectX-Headers'
// wsl/winadapter.h, so the interface pointers this library hands back
// (ID3D11Device*, ID3D11Texture2D*, ...) are the same types the rest of the
// engine already builds against via dxvk-native - not a second, independent
// reimplementation of IUnknown/GUID/HRESULT/etc.
#include <xr_directxtex_winnt_compat.h>
#include <windows.h>
#include <d3d11_2.h>
#include <d3d10.h>
