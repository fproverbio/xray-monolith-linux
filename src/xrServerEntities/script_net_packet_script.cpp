...
template<> void CScriptNetPacket::script_register(lua_State* L)
{
	module(L)
	[
		...
		.def("w_chunk_open8", &NET_Packet::w_chunk_open8, pure_out_value<2>())
		.def("w_chunk_close8", &NET_Packet::w_chunk_close8)
		.def("w_chunk_open16", &NET_Packet::w_chunk_open16, pure_out_value<2>())
		...
		.def("r_float", (void (NET_Packet::*)(float&))(&NET_Packet::r_float), pure_out_value<2>())
		.def("r_u64", (void (NET_Packet::*)(u64&))(&NET_Packet::r_u64), pure_out_value<2>())
		.def("r_s64", (void (NET_Packet::*)(s64&))(&NET_Packet::r_s64), pure_out_value<2>())
		.def("r_u32", (void (NET_Packet::*)(u32&))(&NET_Packet::r_u32), pure_out_value<2>())
		.def("r_s32", (void (NET_Packet::*)(s32&))(&NET_Packet::r_s32), pure_out_value<2>())
		.def("r_u16", (void (NET_Packet::*)(u16&))(&NET_Packet::r_u16), pure_out_value<2>())
		.def("r_s16", (void (NET_Packet::*)(s16&))(&NET_Packet::r_s16), pure_out_value<2>())
		.def("r_u8", (void (NET_Packet::*)(u8&))(&NET_Packet::r_u8), pure_out_value<2>())
		.def("r_s8", (void (NET_Packet::*)(s8&))(&NET_Packet::r_s8), pure_out_value<2>())
		.def("r_bool", &r_bool)
		.def("r_float_q16", (void (NET_Packet::*)(float&, float, float))(&NET_Packet::r_float_q16), pure_out_value<2>())
		.def("r_float_q8", (void (NET_Packet::*)(float&, float, float))(&NET_Packet::r_float_q8), pure_out_value<2>())
		.def("r_angle16", &NET_Packet::r_angle16, pure_out_value<2>())
		.def("r_angle8", &NET_Packet::r_angle8, pure_out_value<2>())
		.def("r_dir", &NET_Packet::r_dir, pure_out_value<2>())
		.def("r_sdir", &NET_Packet::r_sdir, pure_out_value<2>())
