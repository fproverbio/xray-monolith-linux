...
// random_dir() is defined in WeaponFire.cpp (un-excluded 2026-08-30, see
// CMakeLists.txt) - declare it extern here rather than re-defining it, same
// precedent as ShootingObject.cpp's own extern declaration below.
