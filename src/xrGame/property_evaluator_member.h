...
public:
	// _condition_type/_value_type are actually public on the dependent
	// base CPropertyEvaluator<_object_type> - restated here (public,
	// matching the base) only for the `typename inherited::`
